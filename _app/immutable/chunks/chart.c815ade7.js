...
function ee(i) {
    return bt(ye(i * 2.55), 0, 255)
}

function vt(i) {
    return bt(ye(i * 255), 0, 255)
}

function ft(i) {
    return bt(ye(i / 2.55) / 100, 0, 1)
}

function Zi(i) {
    return bt(ye(i * 100), 0, 100)
}
const it = {
        0: 0,
        1: 1,
...
function Ei(i) {
    const e = i.r / 255,
        ...
        r = (o + a) / 2;
    let l, c, h;
    return o !== a && (h = o - a, c = r > .5 ? h / (2 - o - a) : h / (o + a), l = Co(e, s, n, h, o), l = l * 60 + .5), [l | 0, c || 0, r]
}
...
function Lo(i) {
    ...
    let e = 255,
        s;
    if (!t) return;
    t[5] !== s && (e = t[6] ? ee(+t[5]) : vt(+t[5]));
    const n = Mn(+t[2]),
        o = +t[3] / 100,
        a = +t[4] / 100;
    return t[1] === "hwb" ? s = Ao(n, o, a) : t[1] === "hsv" ? s = To(n, o, a) : s = Ii(n, o, a), {
        r: s[0],
        g: s[1],
        b: s[2],
        a: e
...
function Fo() {
    ...
    for (s = 0; s < t.length; s++) {
        ...
        o = parseInt(Qi[a], 16), i[r] = [o >> 16 & 255, o >> 8 & 255, o & 255]
    }
    return i
}
let Se;
...
function Bo(i) {
    ...
    if (t) {
        if (t[7] !== s) {
            const a = +t[7];
            e = t[8] ? ee(a) : bt(a * 255, 0, 255)
        }
        return s = +t[1], n = +t[3], o = +t[5], s = 255 & (t[2] ? ee(s) : bt(s, 0, 255)), n = 255 & (t[4] ? ee(n) : bt(n, 0, 255)), o = 255 & (t[6] ? ee(o) : bt(o, 0, 255)), {
            r: s,
            g: n,
            b: o,
            a: e
...
const ai = i => i <= .0031308 ? i * 12.92 : Math.pow(i, 1 / 2.4) * 1.055 - .055,
    Ht = i => i <= .04045 ? i / 12.92 : Math.pow((i + .055) / 1.055, 2.4);
...
function Wo(i, t, e) {
    const s = Ht(ft(i.r)),
        ...
        o = Ht(ft(i.b));
    return {
        r: vt(ai(s + e * (Ht(ft(t.r)) - s))),
        g: vt(ai(n + e * (Ht(ft(t.g)) - n))),
        b: vt(ai(o + e * (Ht(ft(t.b)) - o))),
        a: i.a + e * (t.a - i.a)
    }
}
...
class ue {
    constructor(t) {
        ...
        const e = typeof t;
        let s;
        e === "object" ? s = ts(t) : e === "string" && (s = ko(t) || Io(t) || No(t)), this._rgb = s, this._valid = !!s
    }
    get valid() {
        return this._valid
    }
...
const jo = (i, t) => typeof i == "string" && i.endsWith("%") ? parseFloat(i) / 100 : +i / t,
...
function Yo(i, t, e) {
    ...
    const s = t[i],
        n = e[i];
    A(s) && A(n) ? re(s, n) : Object.prototype.hasOwnProperty.call(t, i) || (t[i] = Ke(n))
}
const es = {
    "": i => i,
    x: i => i.x,
...
const Wi = i => i === "start" ? "left" : i === "end" ? "right" : "center",
    ...
    oa = (i, t, e, s) => i === (s ? "left" : "right") ? e : i === "center" ? (t + e) / 2 : t;
...
function Ln(i, t, e) {
    ...
    if (i._sorted) {
        ...
        d && (n = Y(Math.min(pt(r, l, c).lo, e ? s : pt(t, l, a.getPixelForValue(c)).lo), 0, s - 1)), u ? o = Y(Math.max(pt(r, a.axis, h, !0).hi + 1, e ? 0 : pt(t, l, a.getPixelForValue(h), !0).hi + 1), n, s) - n : o = s - n
    }
    return {
        start: n,
        count: o
...
const De = i => i === 0 || i === 1,
    ...
    ce = {
        ...
        easeInOutExpo: i => De(i) ? i : i < .5 ? .5 * Math.pow(2, 10 * (i * 2 - 1)) : .5 * (-Math.pow(2, -10 * (i * 2 - 1)) + 2),
        easeInCirc: i => i >= 1 ? i : -(Math.sqrt(1 - i * i) - 1),
        easeOutCirc: i => Math.sqrt(1 - (i -= 1) * i),
        easeInOutCirc: i => (i /= .5) < 1 ? -.5 * (Math.sqrt(1 - i * i) - 1) : .5 * (Math.sqrt(1 - (i -= 2) * i) + 1),
        easeInElastic: i => De(i) ? i : rs(i, .075, .3),
        easeOutElastic: i => De(i) ? i : ls(i, .075, .3),
        easeInOutElastic(i) {
            return De(i) ? i : i < .5 ? .5 * rs(i * 2, .1125, .45) : .5 + .5 * ls(i * 2 - 1, .1125, .45)
        },
        easeInBack(i) {
        ...
        easeInOutBounce: i => i < .5 ? ce.easeInBounce(i * 2) * .5 : ce.easeOutBounce(i * 2 - 1) * .5 + .5
    };
...
function ri(i) {
    return Ni(i) ? i : new ue(i).saturate(.5).darken(.1).hexString()
}
...
const En = {
    ...
    logarithmic(i, t, e) {
        ...
        return [1, 2, 3, 5, 10, 15].includes(s) || t > .8 * e.length ? En.numeric.call(this, i, t, e) : ""
    }
};
...
function pa(i, t, e, s) {
    ...
    for (l = 0; l < r; l++)
        ...
        for (c = 0, h = d.length; c < h; c++) u = d[c], u != null && !I(u) && (a = Ge(i, n, o, a, u));
    i.restore();
    const f = o.length / 2;
    if (f > e.length) {
    ...
    if (!(isNaN(p) || p <= 0)) {
        switch (i.beginPath(), f) {
            ...
            case "rectRounded":
                ...
                l = p - c,
                a = Math.cos(m + Dt) * l,
                d = Math.cos(m + Dt) * (n ? n / 2 - c : l),
                r = Math.sin(m + Dt) * l,
                u = Math.sin(m + Dt) * (n ? n / 2 - c : l),
...
function Bt(i, t, e, s, n, o = {}) {
    ...
    let l, c;
    for (i.save(), i.font = n.string, xa(i, o), l = 0; l < a.length; ++l) c = a[l], o.backdrop && ya(i, o.backdrop), r && (o.strokeColor && (i.strokeStyle = o.strokeColor), L(o.strokeWidth) || (i.lineWidth = o.strokeWidth), i.strokeText(c, e, s, o.maxWidth)), i.fillText(c, e, s, o.maxWidth), _a(i, e, s, c, o), s += Number(n.lineHeight);
    i.restore()
}
...
function $(i, t) {
    ...
    s && !("" + s).match(Ma) && (console.warn('Invalid font style specified: "' + s + '"'), s = void 0);
    const n = {
...
function ie(i, t, e, s) {
    ...
    for (o = 0, a = i.length; o < a; ++o)
        if (r = i[o], r !== void 0 && (t !== void 0 && typeof r == "function" && (r = r(t), n = !1), e !== void 0 && I(r) && (r = r[e % r.length], n = !1), r !== void 0)) return s && !n && (s.cacheable = !1), r
}
...
function Sa(i, t, e) {
    const {
        min: s,
        max: n
    } = i, o = wn(t, (n - s) / 2), a = (r, l) => e && r === 0 ? 0 : r + l;
    return {
        min: a(s, -Math.abs(o)),
        max: a(n, o)
    }
...
const Pa = (i, t) => i ? i + zi(t) : t,
    $i = (i, t) => A(t) && i !== "adapters" && (Object.getPrototypeOf(t) === null || t.constructor === Object);
...
function Da(i, t, e) {
    ...
    let r = s[t];
    return kt(r) && a.isScriptable(t) && (r = Oa(t, r, i, e)), I(r) && r.length && (r = Ca(t, r, i, a.isIndexable)), $i(t, r) && (r = Xt(r, n, o && o[t], a)), r
}
...
const Aa = (i, t) => i === !0 ? t : typeof i == "string" ? Mt(t, i) : void 0;
...
function Yi(i, t, e, s) {
    ...
    return l === null || typeof o < "u" && o !== e && (l = us(r, a, o, l, s), l === null) ? !1 : ji(Array.from(r), [""], n, o, () => La(t, e, s))
}
...
function Ra(i, t, e, s) {
    let n;
    for (const o of t)
        if (n = Wn(Pa(o, i), e), typeof n < "u") return $i(i, n) ? Yi(e, s, i, n) : n
}
...
function Wa(i, t) {
    ...
    for (e = 0, s = i.length; e < s; ++e) a = o, o = r, r = e < s - 1 && mt(i[e + 1], t), o && (n = i[e], a && (n.cp1x = Oe(n.cp1x, t.left, t.right), n.cp1y = Oe(n.cp1y, t.top, t.bottom)), r && (n.cp2x = Oe(n.cp2x, t.left, t.right), n.cp2y = Oe(n.cp2y, t.top, t.bottom)))
}

function Na(i, t, e, s, n) {
    let o, a, r, l;
    if (t.spanGaps && (i = i.filter(c => !c.skip)), t.cubicInterpolationMode === "monotone") Va(i, n);
    else {
        let c = s ? i[i.length - 1] : i[0];
        for (o = 0, a = i.length; o < a; ++o) r = i[o], l = Ia(c, r, i[Math.min(o + 1, a - (s ? 0 : 1)) % a], t.tension), r.cp1x = l.previous.x, r.cp1y = l.previous.y, r.cp2x = l.next.x, r.cp2y = l.next.y, c = r
    }
...
function Tt(i, t) {
    ...
    } = t, n = ni(e), o = n.boxSizing === "border-box", a = It(n, "padding"), r = It(n, "border", "width"), {
        x: l,
        y: c,
        box: h
    } = Ya(i, e), d = a.left + (h && r.left), u = a.top + (h && r.top);
    let {
        width: f,
        height: g
    } = t;
...
function Xn(i, t, e) {
    ...
    const y = () => l(n, v, b) && r(n, v) !== 0,
        ...
        k = () => p || y(),
        w = () => !p || _();
    for (let S = h, P = h; S <= d; ++S) x = t[S % a], !x.skip && (b = c(x[s]), b !== v && (p = l(b, n, o), m === null && k() && (m = r(b, n) === 0 ? S : P), m !== null && w() && (g.push(ms({
        start: m,
        end: S,
        loop: u,
        count: a,
    ...
    for (const g of t) {
        ...
        for (u = d + 1; u <= g.end; u++) {
            ...
            m = xs(s.setContext(wt(n, {
                ...
                p1DataIndex: u % l,
                datasetIndex: a
            }))), nr(m, h) && f(d, u - 1, g.loop, h), p = b, h = m
        }
...
class rr {
    constructor(t, e, s, n) {
        ...
        this._active = !0, this._fn = t.fn || ar[t.type || typeof a], this._easing = ce[t.easing] || ce.linear, this._start = Math.floor(Date.now() + (t.delay || 0)), this._duration = this._total = Math.floor(t.duration), this._loop = !!t.loop, this._target = e, this._prop = s, this._from = a, this._to = n, this._promises = void 0
    }
    active() {
        return this._active
    }
    update(t, e, s) {
        if (this._active) {
            ...
            const n = this._target[this._prop],
                o = s - this._start,
                a = this._duration - o;
            this._start = s, this._duration = Math.floor(Math.max(a, t.duration)), this._total += o, this._loop = !!t.loop, this._to = ie([t.to, e, n, t.from]), this._from = ie([t.from, n, e])
        }
    }
    cancel() {
...
function ws(i, t) {
    const {
        ...
        vScale: a,
        index: r
    } = s, l = o.axis, c = a.axis, h = fr(o, a, s), d = t.length;
    let u;
    for (let f = 0; f < d; ++f) {
        const g = t[f],
            {
        ...
        u = b[c] = pr(n, h, p), u[r] = m, u._top = ks(u, a, !0, s.type), u._bottom = ks(u, a, !1, s.type);
...
const hi = i => i === "reset" || i === "none",
    ...
    xr = (i, t, e) => i && !t.hidden && t._stacked && {
        keys: qn(e, !0),
        values: null
    };
class ot {
    ...
    buildOrUpdateElements(t) {
        ...
        this._dataCheck();
        const o = e._stacked;
        e._stacked = Ms(e.vScale, e), e.stack !== s.stack && (n = !0, Gt(e), e.stack = s.stack), this._resyncElements(t), (n || o !== e._stacked) && ws(this, e._parsed)
    }
    configure() {
    ...
    parsePrimitiveData(t, e, s, n) {
        const {
            iScale: o,
            vScale: a
        } = t, r = o.axis, l = a.axis, c = o.getLabels(), h = o === a, d = new Array(n);
        let u, f, g;
    ...
    updateRangeFromParsed(t, e, s, n) {
        ...
        n && r && (n.values = r, a = vs(n, o, this._cachedMeta.index)), t.min = Math.min(t.min, a), t.max = Math.max(t.max, a)
    }
    getMinMax(t, e) {
    ...
    getContext(t, e, s) {
        ...
        if (t >= 0 && t < this._cachedMeta.data.length) {
            ...
            o = a.$context || (a.$context = br(this.getContext(), t, a)), o.parsed = this.getParsed(t), o.raw = n.data[t], o.index = o.dataIndex = t
        } else o = this.$context || (this.$context = mr(this.chart.getContext(), this.index)), o.dataset = n, o.index = o.datasetIndex = this.index;
...
function Ps(i, t, e, s) {
    const n = i.iScale,
        ...
        l = [];
    let c, h, d, u;
    for (c = e, h = e + s; c < h; ++c) u = t[c], d = {}, d[n.axis] = r || n.parse(a[c], c), l.push(Gn(u, d, o, c));
    return l
}
...
class Be extends ot {
    ...
    parseObjectData(t, e, s, n) {
        const {
            ...
            xAxisKey: r = "x",
            yAxisKey: l = "y"
        } = this._parsing, c = o.axis === "x" ? r : l, h = a.axis === "x" ? r : l, d = [];
        let u, f, g, p;
        for (u = s, f = s + n; u < f; ++u) p = e[u], g = {}, g[o.axis] = o.parse(Mt(p, c), u), d.push(Gn(Mt(p, h), g, a, u));
        return d
    }
    updateRangeFromParsed(t, e, s, n) {
    ...
    getLabelAndValue(t) {
        const e = this._cachedMeta,
            ...
            o = this.getParsed(t),
            a = o._custom,
            r = di(a) ? "[" + a.start + ", " + a.end + "]" : "" + n.getLabelForValue(o[n.axis]);
        return {
    ...
    _calculateBarValuePixels(t) {
        ...
        } = this, r = o || 0, l = this.getParsed(t), c = l._custom, h = di(c);
        let d = l[e.axis],
            u = 0,
...
function Lr(i, t, e, s) {
    ...
    if (r && t === r.axis && t !== "r" && a && o.length) {
        const l = r._reversePixels ? ea : pt;
        if (s) {
            if (n._sharedOptions) {
                const c = o[0],
...
function ui(i, t, e, s, n) {
    ...
    return !n && !i.isPointInArea(t) || Me(i, e, t, function(r, l, c) {
        !n && !mt(r, i.chartArea, 0) || r.inRange(t.x, t.y, s) && o.push({
            element: r,
            datasetIndex: l,
            index: c
        })
...
function fi(i, t, e, s, n, o) {
    return !o && !i.isPointInArea(t) ? [] : e === "r" && !s ? Er(i, t, e, n) : Fr(i, t, e, s, n, o)
}
...
function Wr(i) {
    const t = zr(i),
        e = Jt(t.filter(c => c.box.fullSize), !0),
        s = Jt(Zt(t, "left"), !0),
        n = Jt(Zt(t, "right")),
        o = Jt(Zt(t, "top"), !0),
        a = Jt(Zt(t, "bottom")),
...
function se(i, t, e, s) {
    ...
    for (o = 0, a = i.length, c = 0; o < a; ++o) {
        r = i[o], l = r.box, l.update(r.width || t.w, r.height || t.h, jr(r.horizontal, t));
        const {
            same: d,
            other: u
        } = Nr(t, e, r, s);
...
var q = {
    ...
    update(i, t, e, s) {
        ...
        const f = Object.assign({
            ...
            g = Vr(l.concat(c), d);
        se(r.fullSize, f, d, g), se(l, f, d, g), se(c, f, d, g) && se(l, f, d, g), Hr(f), Ls(r.leftAndTop, f, d, g), f.x += f.w, f.y += f.h, Ls(r.rightAndBottom, f, d, g), i.chartArea = {
            left: f.left,
            top: f.top,
            right: f.left + f.w,
            bottom: f.top + f.h,
...
function sl(i) {
    return !Xi() || typeof OffscreenCanvas < "u" && i instanceof OffscreenCanvas ? $r : il
}
class at {
    constructor() {
        M(this, "x");
...
function nl(i, t) {
    ...
    if (a > 0) {
        ...
        for (Te(t, c, h, L(f) ? 0 : r - f, r), d = 0, u = a - 1; d < u; d++) Te(t, c, h, o[d], o[d + 1]);
...
class Vt extends at {
    ...
    update(t, e, s) {
        ...
        this.beforeUpdate(), this.maxWidth = t, this.maxHeight = e, this._margins = s = Object.assign({
            ...
            top: 0,
            bottom: 0
        }, s), this.ticks = null, this._labelSizes = null, this._gridLineItems = null, this._labelItems = null, this.beforeSetDimensions(), this.setDimensions(), this.afterSetDimensions(), this._maxLength = this.isHorizontal() ? this.width + s.left + s.right : this.height + s.top + s.bottom, this._dataLimitsCached || (this.beforeDataLimits(), this.determineDataLimits(), this.afterDataLimits(), this._range = Sa(this, o, n), this._dataLimitsCached = !0), this.beforeBuildTicks(), this.ticks = this.buildTicks() || [], this.afterBuildTicks();
    ...
    calculateLabelRotation() {
        ...
        r = t.offset ? this.maxWidth / s : f / (s - 1), d + 6 > r && (r = f / (s - (t.offset ? .5 : 1)), l = this.maxHeight - Qt(t.grid) - e.padding - Bs(t.title, this.chart.options.font), c = Math.sqrt(d * d + u * u), a = Bi(Math.min(Math.asin(Y((h.highest.height + 6) / r, -1, 1)), Math.asin(Y(l / c, -1, 1)) - Math.asin(Y(u / c, -1, 1)))), a = Math.max(n, Math.min(o, a))), this.labelRotation = a
    }
        ...
        if (a) {
            ...
            if (r ? (t.width = this.maxWidth, t.height = Qt(o) + l) : (t.height = this.maxHeight, t.width = Qt(o) + l), s.display && this.ticks.length) {
                const {
                    ...
                    widest: d,
                    highest: u
                } = this._getLabelSizes(), f = s.padding * 2, g = nt(this.labelRotation), p = Math.cos(g), m = Math.sin(g);
                if (r) {
    ...
    _computeLabelSizes(t, e, s) {
        const {
            ctx: n,
            _longestTextCache: o
        } = this, a = [], r = [], l = Math.floor(e / Is(e, s));
        let c = 0,
            h = 0,
            d, u, f, g, p, m, b, x, v, y, _;
        for (d = 0; d < e; d += l) {
            if (g = t[d].label, p = this._resolveTickFontOptions(d), n.font = m = p.string, b = o[m] = o[m] || {
                    data: {},
                    gc: []
                }, x = p.lineHeight, v = y = 0, !L(g) && !I(g)) v = Ge(n, b.data, b.gc, v, g), y = x;
            else if (I(g))
                for (u = 0, f = g.length; u < f; ++u) _ = g[u], !L(_) && !I(_) && (v = Ge(n, b.data, b.gc, v, _), y += x);
    ...
    getPixelForDecimal(t) {
        ...
        return ta(this._alignToPixels ? Ot(this.chart, e, 0) : e)
    }
    ...
    _computeGridLineItems(t) {
        ...
        if (a === "top") x = b(this.bottom), w = this.bottom - u, P = x - m, C = b(t.top) + m, X = t.bottom;
        else if (a === "bottom") x = b(this.top), C = t.top, X = b(t.bottom) - m, w = x + m, P = this.top + u;
        else if (a === "left") x = b(this.right), k = this.right - u, S = x - m, O = b(t.left) + m, T = t.right;
        else if (a === "right") x = b(this.left), O = t.left, T = b(t.right) - m, k = x + m, S = this.left + u;
        else if (e === "x") {
        ...
        for (v = 0; v < d; v += E) {
            const V = this.getContext(v),
                ...
                St = H.tickColor,
                qt = H.tickBorderDash || [],
                Pt = H.tickBorderDashOffset;
            y = dl(this, v, l), y !== void 0 && (_ = Ot(s, y, U), c ? k = S = O = T = _ : w = P = C = X = _, f.push({
                tx1: k,
                ty1: w,
                tx2: S,
                ty2: P,
    ...
    _computeLabelItems(t) {
        const e = this.axis,
            ...
            m = [];
        let b, x, v, y, _, k, w, S, P, O, C, T, X = "middle";
        ...
        for (b = 0, x = r.length; b < x; ++b) {
            ...
            S = this.getPixelForTick(b) + o.labelOffset, P = this._resolveTickFontOptions(b), O = P.lineHeight, C = I(y) ? y.length : 1;
            const V = C / 2,
                H = E.color,
                st = E.textStrokeColor,
                U = E.textStrokeWidth;
            let Wt = w;
            a ? (_ = S, w === "inner" && (b === x - 1 ? Wt = this.options.reverse ? "left" : "right" : b === 0 ? Wt = this.options.reverse ? "right" : "left" : Wt = "center"), n === "top" ? c === "near" || p !== 0 ? T = -C * O + O / 2 : c === "center" ? T = -Q.highest.height / 2 - V * O + O : T = -Q.highest.height + O / 2 : c === "near" || p !== 0 ? T = O / 2 : c === "center" ? T = Q.highest.height / 2 - V * O : T = Q.highest.height - C * O, d && (T *= -1), p !== 0 && !E.showLabelBackdrop && (_ += O / 2 * Math.sin(p))) : (k = S, T = (1 - C) * O / 2);
            let ke;
    ...
    _getYAxisLabelAlignment(t) {
        ...
        } = this.options, a = this._getLabelSizes(), r = t + o, l = a.widest.width;
        let c, h;
...
class Le {
    ...
    register(t) {
        ...
        return o in n || (n[o] = t, bl(t, a, s), this.override && N.override(t.id, t.overrides)), a
    }
    get(t) {
        return this.items[t]
    }
    unregister(t) {
        const e = this.items,
            s = t.id,
            n = this.scope;
        s in e && delete e[s], n && s in N[n] && (delete N[n][s], this.override && delete zt[s])
    }
}

function bl(i, t, e) {
    const s = fe(Object.create(null), [e ? N.get(e) : {}, N.get(t), i.defaults]);
    N.set(t, s), i.defaultRoutes && xl(t, i.defaultRoutes), i.descriptors && N.describe(t, i.descriptors)
}
...
class yl {
    constructor() {
        this.controllers = new Le(ot, "datasets", !0), this.elements = new Le(at, "elements"), this.plugins = new Le(Object, "plugins"), this.scales = new Le(Vt, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
    }
    add(...t) {
...
function wi(i, ...t) {
    if (Vs(i)) return i;
    for (const e of t) {
        const s = e.axis || Ol(e.position) || i.length > 1 && Vs(i[0].toLowerCase());
        if (s) return s
    }
...
function Al(i, t) {
    ...
    return Object.keys(s).forEach(a => {
        ...
        Object.keys(h).forEach(d => {
            const u = Pl(d, l),
                f = a[u + "AxisID"] || u;
            o[f] = o[f] || Object.create(null), re(o[f], [{
                axis: u
            }, s[f], h[d]])
        })
...
class Ll {
    ...
    getOptionScopes(t, e, s) {
        ...
        const l = new Set;
        e.forEach(h => {
            t && (l.add(t), h.forEach(d => te(l, t, d))), h.forEach(d => te(l, n, d)), h.forEach(d => te(l, zt[o] || {}, d)), h.forEach(d => te(l, N, d)), h.forEach(d => te(l, yi, d))
        });
        const c = Array.from(l);
        return c.length === 0 && c.push(Object.create(null)), no.has(e) && a.set(e, c), c
    }
    chartOptionScopes() {
        const {
            options: t,
...
const Rl = i => A(i) && Object.getOwnPropertyNames(i).some(t => kt(i[t]));
...
class Rt {
    ...
    constructor(t, e) {
        ...
        dt.listen(this, "complete", Ys), dt.listen(this, "progress", zl), this._initialize(), this.attached && this.update()
    }
    get aspectRatio() {
        const {
            options: {
    ...
    _resize(t, e) {
        ...
        this.width = a.width, this.height = a.height, this._aspectRatio = this.aspectRatio, gs(this, r, !0) && (this.notifyPlugins("resize", {
            size: a
        }), F(s.onResize, [this, a], this), this.attached && this._doResize(l) && this.render())
    }
    ensureScalesHaveIDs() {
    ...
    buildOrUpdateControllers() {
        ...
        for (this._removeUnreferencedMetasets(), s = 0, n = e.length; s < n; s++) {
            ...
            if (a.type && a.type !== r && (this._destroyDatasetMeta(s), a = this.getDatasetMeta(s)), a.type = r, a.indexAxis = o.indexAxis || ki(r, this.options), a.order = o.order || 0, a.index = s, a.label = "" + o.label, a.visible = this.isDatasetVisible(s), a.controller) a.controller.updateIndex(s), a.controller.linkScales();
            else {
    ...
    _checkEventBindings() {
        const t = this.options,
            ...
            s = new Set(t.events);
        (!is(e, s) || !!this._responsiveListeners !== t.responsive) && (this.unbindEvents(), this.bindEvents())
    }
    ...
    _updateDatasets(t) {
        if (this.notifyPlugins("beforeDatasetsUpdate", {
            ...
            for (let e = 0, s = this.data.datasets.length; e < s; ++e) this._updateDataset(e, kt(t) ? t({
                datasetIndex: e
            }) : t);
    ...
    destroy() {
        ...
        this._stop(), this.config.clearCache(), t && (this.unbindEvents(), ds(t, e), this.platform.releaseContext(e), this.canvas = null, this.ctx = null), delete $e[this.id], this.notifyPlugins("afterDestroy")
    }
    toBase64Image(...t) {
    ...
    _handleEvent(t, e, s) {
        const {
            _active: n = [],
            options: o
        } = this, a = e, r = this._getActiveElements(t, n, s, a), l = Ko(t), c = Vl(t, this._lastEvent, s, l);
...
M(Rt, "defaults", N), M(Rt, "instances", $e), M(Rt, "overrides", zt), M(Rt, "registry", lt), M(Rt, "version", Fl), M(Rt, "getChart", Xs);

function Us() {
    return R(Rt.instances, i => i._plugins.invalidate())
}
...
function Qe(i, t, e, s, n, o) {
    ...
    const p = Math.max(.001, g * d - e / B) / d,
        m = (g - p) / 2,
        b = l + m + f,
        x = n - m - f,
        {
...
class ne extends at {
    ...
    getCenterPoint(e) {
        const {
            ...
            offset: c,
            spacing: h
        } = this.options, d = (o + a) / 2, u = (r + l + h + c) / 2;
        return {
            x: s + Math.cos(d) * u,
            y: n + Math.sin(d) * u
        }
    ...
    draw(e) {
        const {
            options: s,
            circumference: n
        } = this, o = (s.offset || 0) / 4, a = (s.spacing || 0) / 2, r = s.circular;
        if (this.pixelMargin = s.borderAlign === "inner" ? .33 : 0, this.fullCircles = n > z ? Math.floor(n / z) : 0, n === 0 || this.innerRadius < 0 || this.outerRadius < 0) return;
        e.save();
        const l = (this.startAngle + this.endAngle) / 2;
        e.translate(Math.cos(l) * o, Math.sin(l) * o);
        const c = 1 - Math.sin(Math.min(B, n || 0)),
            h = o * c;
        e.fillStyle = s.backgroundColor, e.strokeStyle = s.borderColor, $l(e, this, h, a, r), Yl(e, this, h, a, r), e.restore()
    }
}
...
function Ul(i) {
    return i.stepped ? ma : i.tension || i.cubicInterpolationMode === "monotone" ? ba : Xl
}
...
function Gl(i) {
    return i.stepped ? qa : i.tension || i.cubicInterpolationMode === "monotone" ? Ga : Lt
}
...
function Jl(i, t, e, s) {
    ...
    for (const r of n) ao(i, o, r.style), i.beginPath(), a(i, t, r, {
        start: e,
        end: e + s - 1
...
class Ye extends at {
    ...
    draw(e, s) {
        ...
        this.skip || n.radius < .1 || !mt(this, s, this.size(n) / 2) || (e.strokeStyle = n.borderColor, e.lineWidth = n.borderWidth, e.fillStyle = n.backgroundColor, vi(e, n, this.x, this.y))
    }
    getRange() {
...
function ic(i, t, e) {
    ...
    } = i.getProps(["enableBorderRadius"]), n = i.options.borderRadius, o = Ft(n), a = Math.min(t, e), r = i.borderSkipped, l = s || A(n);
    return {
        topLeft: yt(!l || r.top || r.left, o.topLeft, 0, a),
        topRight: yt(!l || r.top || r.right, o.topRight, 0, a),
        bottomLeft: yt(!l || r.bottom || r.left, o.bottomLeft, 0, a),
        bottomRight: yt(!l || r.bottom || r.right, o.bottomRight, 0, a)
    }
}
...
const Pi = ["rgb(54, 162, 235)", "rgb(255, 99, 132)", "rgb(255, 159, 64)", "rgb(255, 205, 86)", "rgb(75, 192, 192)", "rgb(153, 102, 255)", "rgb(201, 203, 207)"],
...
function hc(i) {
    ...
    return (e, s) => {
        ...
        n instanceof Et ? t = lc(e, t) : n instanceof de ? t = cc(e, t) : n && (t = rc(e, t))
    }
}
...
function fc(i, t, e, s, n) {
    ...
    for (a[l++] = i[h], d = 0; d < o - 2; d++) {
        ...
        for (f = g = -1, x = k; x < w; x++) g = .5 * Math.abs((S - m) * (i[x].y - P) - (S - i[x].x) * (b - P)), g > f && (f = g, u = i[x], p = x);
        a[l++] = u, h = p
    }
    return a[l++] = i[c], a
}
...
function pc(i, t) {
    ...
    return l && (s = Y(pt(t, o.axis, a).lo, 0, e - 1)), c ? n = Y(pt(t, o.axis, r).hi + 1, s, e) - s : n = e - s, {
        start: s,
        count: n
    }
}
var mc = {
    ...
    beforeElementsUpdate: (i, t, e) => {
        ...
        i.data.datasets.forEach((n, o) => {
            ...
            if (ie([r, i.options.indexAxis]) === "y" || !l.controller.supportsDecimation) return;
...
function fo(i, t) {
    let e = [],
        s = !1;
    return I(i) ? (s = !0, e = i) : e = xc(i, t), e.length ? new _t({
        points: e,
        options: {
            tension: 0
        },
...
function yc(i, t, e) {
    ...
    let n = parseFloat(s);
    return W(n) && Math.floor(n) === n ? vc(s[0], t, n, e) : ["origin", "start", "end", "stack", "shape"].indexOf(s) >= 0 && s
}
...
function Sc(i) {
    const {
        ...
        index: e,
        line: s
    } = i, n = [], o = s.segments, a = s.points, r = Pc(t, e);
    r.push(fo({
        x: null,
        y: t.bottom
    }, s));
...
function Rc(i) {
    const {
        scale: t,
        fill: e
    } = i, s = t.options, n = t.getLabels().length, o = s.reverse ? t.max : t.min, a = kc(e, t, o), r = [];
    if (s.grid.circular) {
...
function Ec(i, t) {
    ...
    i.save(), l === "x" && o !== n && (tn(i, s, a.top), en(i, {
        line: e,
        target: s,
        color: n,
        scale: r,
...
var Ic = {
    ...
    afterDatasetsUpdate(i, t, e) {
        const s = (i.data.datasets || []).length,
            n = [];
        let o, a, r, l;
        for (a = 0; a < s; ++a) o = i.getDatasetMeta(a), r = o.dataset, l = null, r && r.options && r instanceof _t && (l = {
        ...
        for (a = 0; a < s; ++a) l = n[a], !(!l || l.fill === !1) && (l.fill = _c(n, a, e.propagate))
    },
    beforeDraw(i, t, e) {
...
const nn = (i, t) => {
    ...
    zc = (i, t) => i !== null && t !== null && i.datasetIndex === t.datasetIndex && i.index === t.index;
class on extends at {
    constructor(t) {
    ...
    _fitRows(t, e, s, n) {
        ...
        } = this, l = this.legendHitBoxes = [], c = this.lineWidths = [0], h = n + r;
        let d = t;
    ...
    _fitCols(t, e, s, n) {
        ...
        } = this, l = this.legendHitBoxes = [], c = this.columnSizes = [], h = a - t;
        let d = r,
            u = 0,
            f = 0,
            g = 0,
    ...
    adjustHitBoxes() {
        ...
        if (this.isHorizontal()) {
            ...
            for (const c of e) r !== c.row && (r = c.row, l = K(s, this.left + n, this.right - this.lineWidths[r])), c.top += this.top + t + n, c.left = a.leftForLtr(a.x(l), c.width), l += c.width + n
        } else {
            let r = 0,
                l = K(s, this.top + t + n, this.bottom - this.columnSizes[r].height);
            for (const c of e) c.col !== r && (r = c.col, l = K(s, this.top + t + n, this.bottom - this.columnSizes[r].height)), c.top = l, c.left += this.left + n, c.left = a.leftForLtr(a.x(c.left), c.width), l += c.height + n
        }
    }
    isHorizontal() {
    ...
    _draw() {
        const {
            ...
            align: o,
            labels: a
        } = t, r = N.color, l = $t(t.rtl, this.left, this.width), c = $(a.font), {
            padding: h
        } = a, d = c.size, u = d / 2;
        let f;
        ...
        const {
            ...
            if (n.fillStyle = D(S.fillStyle, r), n.lineCap = D(S.lineCap, "butt"), n.lineDashOffset = D(S.lineDashOffset, 0), n.lineJoin = D(S.lineJoin, "miter"), n.lineWidth = P, n.strokeStyle = D(S.strokeStyle, r), n.setLineDash(D(S.lineDash, [])), a.usePointStyle) {
                ...
                const O = w + Math.max((d - p) / 2, 0),
                    C = l.leftForLtr(k, g),
                    T = Ft(S.borderRadius);
                n.beginPath(), Object.values(T).some(X => X !== 0) ? me(n, {
                    x: C,
                    y: O,
                    w: g,
                    h: p,
        ...
        this.legendItems.forEach((k, w) => {
            ...
            let C = f.x,
                T = f.y;
            l.setWidth(this.width), v ? w > 0 && C + O + h > this.right && (T = f.y += _, f.line++, C = f.x = K(o, this.left + h, this.right - s[f.line])) : w > 0 && T + _ > this.bottom && (C = f.x = C + e[f.line].width + h, f.line++, T = f.y = K(o, this.top + y + h, this.bottom - e[f.line].height));
            const X = l.x(C);
            if (b(X, T, k), C = oa(P, C + g + u, v ? C + O : this.right, t.rtl), x(l.x(C), T, k), v) f.x += O + h;
    ...
    drawTitle() {
        ...
        const f = K(r, d, d + u);
        a.textAlign = o.textAlign(Wi(r)), a.textBaseline = "middle", a.strokeStyle = e.color, a.fillStyle = e.color, a.font = s.string, Bt(a, e.text, f, h, s)
    }
    _computeTitleHeight() {
    ...
    _getLegendItemAt(t, e) {
        ...
        if (gt(t, this.left, this.right) && gt(e, this.top, this.bottom)) {
            for (o = this.legendHitBoxes, s = 0; s < o.length; ++s)
                if (n = o[s], gt(t, n.left, n.left + n.width) && gt(e, n.top, n.top + n.height)) return this.legendItems[s]
        }
        return null
    }
    handleEvent(t) {
...
class Gi extends at {
    ...
    _drawArgs(t) {
        ...
        let l = 0,
            c, h, d;
        return this.isHorizontal() ? (h = K(r, s, o), d = e + t, c = o - s) : (a.position === "left" ? (h = s + t, d = K(r, n, e), l = B * -.5) : (h = o - t, d = K(r, e, n), l = B * .5), c = n - e), {
            titleX: h,
            titleY: d,
            maxWidth: c,
            rotation: l
...
function qc(i, t, e, s) {
    ...
    let c = "center";
    return s === "center" ? c = n <= (r + l) / 2 ? "left" : "right" : n <= o / 2 ? c = "left" : n >= a - o / 2 && (c = "right"), Kc(c, i, t, e) && (c = "center"), c
}
...
class Oi extends at {
    ...
    getTitle(t, e) {
        const {
            callbacks: s
        } = e, n = Z(s, "beforeTitle", this, t), o = Z(s, "title", this, t), a = Z(s, "afterTitle", this, t);
        let r = [];
    ...
    getFooter(t, e) {
        const {
            callbacks: s
        } = e, n = Z(s, "beforeFooter", this, t), o = Z(s, "footer", this, t), a = Z(s, "afterFooter", this, t);
        let r = [];
        return r = rt(r, ut(n)), r = rt(r, ut(o)), r = rt(r, ut(a)), r
    }
    _createItems(t) {
    ...
    drawTitle(t, e, s) {
        ...
        if (o) {
            ...
            for (t.x = Ie(this, s.titleAlign, s), e.textAlign = c.textAlign(s.titleAlign), e.textBaseline = "middle", a = $(s.titleFont), r = s.titleSpacing, e.fillStyle = s.titleColor, e.font = a.string, l = 0; l < o; ++l) e.fillText(n[l], c.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + r, l + 1 === o && (t.y += s.titleMarginBottom - r)
        }
    }
    _drawColorBox(t, e, s, n, o) {
        ...
        if (o.usePointStyle) {
            const p = {
                ...
                b = g + l / 2;
            t.strokeStyle = o.multiKeyBackground, t.fillStyle = o.multiKeyBackground, vi(t, p, m, b), t.strokeStyle = a.borderColor, t.fillStyle = a.backgroundColor, vi(t, p, m, b)
        } else {
    ...
    drawBody(t, e, s) {
        ...
        const g = $t(s.rtl, this.x, this.width),
            ...
            m = g.textAlign(a);
        let b, x, v, y, _, k, w;
        for (e.textAlign = a, e.textBaseline = "middle", e.font = d.string, t.x = Ie(this, m, s), e.fillStyle = s.bodyColor, R(this.beforeBody, p), f = r && m !== "right" ? a === "center" ? c / 2 + h : c + 2 + h : 0, y = 0, k = n.length; y < k; ++y) {
            for (b = n[y], x = this.labelTextColors[y], e.fillStyle = x, R(b.before, p), v = b.lines, r && v.length && (this._drawColorBox(e, t, y, g, s), u = Math.max(d.lineHeight, l)), _ = 0, w = v.length; _ < w; ++_) p(v[_]), u = d.lineHeight;
            R(b.after, p)
        }
    ...
    drawFooter(t, e, s) {
        ...
        if (o) {
            ...
            for (t.x = Ie(this, s.footerAlign, s), t.y += s.footerMarginTop, e.textAlign = l.textAlign(s.footerAlign), e.textBaseline = "middle", a = $(s.footerFont), e.fillStyle = s.footerColor, e.font = a.string, r = 0; r < o; ++r) e.fillText(n[r], l.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + s.footerSpacing
        }
    }
    ...
    _positionChanged(t, e) {
        const {
            ...
            caretY: n,
            options: o
        } = this, a = oe[o.position].call(this, t, e);
...
const eh = (i, t, e, s) => (typeof t == "string" ? (e = i.push(t) - 1, s.unshift({
    index: e,
    label: t
})) : isNaN(t) && (e = null), e);
...
class Ci extends Vt {
    ...
    parse(t, e) {
        if (L(t)) return null;
        const s = this.getLabels();
        return e = isFinite(e) && s[e] === t ? e : ih(s, t, D(e, t), this._addedLabels), sh(e, s.length - 1)
    }
    determineDataLimits() {
        const {
            minDefined: t,
...
M(Ci, "id", "category"), M(Ci, "defaults", {
    ticks: {
        callback: dn
    }
});
...
function nh(i, t) {
    ...
    P = Math.ceil(m / _) - Math.floor(p / _), P > g && (_ = ns(P * _ / g / f) * f), L(l) || (k = Math.pow(10, l), _ = Math.ceil(_ * k) / k), n === "ticks" ? (w = Math.floor(p / _) * _, S = Math.ceil(m / _) * _) : (w = p, S = m), b && x && o && Jo((r - a) / o, _ / 1e3) ? (P = Math.round(Math.min((r - a) / _, h)), _ = (r - a) / P, w = a, S = r) : v ? (w = b ? a : w, S = x ? r : S, P = c - 1, _ = (S - w) / P) : (P = (S - w) / _, le(P, Math.round(P), _ / 1e3) ? P = Math.round(P) : P = Math.ceil(P));
    const O = Math.max(os(_), os(w));
    k = Math.pow(10, L(l) ? O : l), w = Math.round(w * k) / k, S = Math.round(S * k) / k;
    let C = 0;
    for (b && (u && w !== a ? (e.push({
            value: a
...
M(Ai, "id", "linear"), M(Ai, "defaults", {
    ticks: {
        callback: ei.formatters.numeric
    }
});
const xe = i => Math.floor(xt(i)),
...
class Ti extends Vt {
    ...
    handleTickRangeOptions() {
        ...
        const o = r => s = t ? s : r,
            a = r => n = e ? n : r;
        s === n && (s <= 0 ? (o(1), a(10)) : (o(At(s, -1)), a(At(n, 1)))), s <= 0 && o(At(n, -1)), n <= 0 && a(At(s, 1)), this.min = s, this.max = n
    }
    buildTicks() {
        const t = this.options,
            e = {
...
M(Ti, "id", "logarithmic"), M(Ti, "defaults", {
    ticks: {
...
function xh(i, t, e, s, n) {
    ...
    !a && !s || !r || !l || e < 0 || (o.save(), o.strokeStyle = r, o.lineWidth = l, o.setLineDash(n.dash), o.lineDashOffset = n.dashOffset, o.beginPath(), bo(i, e, a, s), o.closePath(), o.stroke(), o.restore())
}
...
class ae extends ti {
    ...
    drawGrid() {
        ...
        let r, l, c;
        if (e.pointLabels.display && bh(this, a), n.display && this.ticks.forEach((h, d) => {
                if (d !== 0) {
...
function bn(i, t) {
    ...
    let a = t;
    return typeof s == "function" && (a = s(a)), W(a) || (a = typeof s == "string" ? e.parse(a, s) : e.parse(a)), a === null ? null : (n && (a = n === "week" && (Yt(o) || o === !0) ? e.startOf(a, "isoWeek", o) : e.startOf(a, n)), +a)
}
...
class _e extends Vt {
    ...
    buildTicks() {
        ...
        const o = this.min,
            a = this.max,
            r = ia(n, o, a);
        return this._unit = e.unit || (s.autoSkip ? xn(e.minUnit, this.min, this.max, this._getLabelCapacity(o)) : yh(this, r.length, e.minUnit, this.min, this.max)), this._majorUnit = !s.major.enabled || this._unit === "year" ? void 0 : vh(this._unit), this.initOffsets(n), t.reverse && r.reverse(), yn(this, r, this._majorUnit)
    }
    afterAutoSkip() {
