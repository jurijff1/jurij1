...
import {
    b as qt,
    c as Mt
} from "../chunks/public.748b1c92.js";
import {
    s as yt,
    w as Pe,
    C as ze,
...
import {
    t as Ve
} from "../chunks/toasts.779a04f1.js";
import {
    g as Yt,
    a as Zt
...
import {
    T as es
} from "../chunks/TransitionFrame.1049a54b.js";
import {
    t as We
} from "../chunks/bundle-mjs.290c8c95.js";
import {
    C as ts
} from "../chunks/CloseButton.1b14ac1f.js";
import {
    F as ss
} from "../chunks/Frame.cb9309c9.js";
import {
    a as rs
} from "../chunks/navigation.63b52091.js";
import {
    C as is,
    r as ns
} from "../chunks/chart.c815ade7.js";
import {
    X as os
} from "../chunks/x.a1f5ce3e.js";
import {
    C as as
} from "../chunks/check.d25012d0.js";
new TextEncoder;
const ls = new TextDecoder,
    cs = n => {
        const e = atob(n),
    ...
    hs = n => {
        let e = n;
        e instanceof Uint8Array && (e = ls.decode(e)), e = e.replace(/-/g, "+").replace(/_/g, "/").replace(/\s/g, "");
        try {
            return cs(e)
        } catch {
    ...
    ds = n => {
        let e;
        return n ? e = n : typeof fetch > "u" ? e = (...t) => W(() => Promise.resolve().then(() => ce), void 0,
...
var _s = globalThis && globalThis.__awaiter || function(n, e, t, s) {
    function r(i) {
...
class ms {
    constructor(e, {
        ...
        this.url = e, this.headers = t, this.fetch = ds(s)
    }
    setAuth(e) {
    ...
    invoke(e, t = {}) {
        ...
        return _s(this, void 0, void 0, function*() {
            try {
                ...
                if (h && h === "true") throw new gs(l);
                if (!l.ok) throw new ps(l);
    ...
    then(e, t) {
        ...
        let r = s(this.url.toString(), {
            ...
            if (i.ok) {
                ...
                const f = (o = this.headers.Prefer) === null || o === void 0 ? void 0 : o.match(/count=(exact|planned|estimated)/),
                    p = (a = i.headers.get("content-range")) === null || a === void 0 ? void 0 : a.split("/");
                f && p && p.length > 1 && (u = parseInt(p[1])), this.isMaybeSingle && this.method === "GET" && Array.isArray(h) && (h.length > 1 ? (l = {
                    code: "PGRST116",
                    details: `Results contain ${h.length} rows, application/vnd.pgrst.object+json requires 1 row`,
                    hint: null,
                    message: "JSON object requested, multiple (or no) rows returned"
                }, h = null, u = null, d = 406, g = "Not Acceptable") : h.length === 1 ? h = h[0] : h = null)
            } else {
                const f = await i.text();
                try {
                    l = JSON.parse(f), Array.isArray(l) && i.status === 404 && (h = [], l = null, d = 200, g = "OK")
                } catch {
                    i.status === 404 && f === "" ? (d = 204, g = "No Content") : l = {
                        message: f
                    }
                }
                if (l && this.isMaybeSingle && (!((c = l == null ? void 0 : l.details) === null || c === void 0) && c.includes("0 rows")) && (l = null, d = 200, g = "OK"), l && this.shouldThrowOnError) throw l
            }
            return {
                error: l,
                data: h,
...
class Ts {
    ...
    select(e, {
        ...
        return this.url.searchParams.set("select", o), s && (this.headers.Prefer = `count=${s}`), new K({
            method: r,
            url: this.url,
            headers: this.headers,
            schema: this.schema,
    ...
    update(e, {
        ...
        const s = "PATCH",
            r = [];
        return this.headers.Prefer && r.push(this.headers.Prefer), t && r.push(`count=${t}`), this.headers.Prefer = r.join(","), new K({
            method: s,
            url: this.url,
            headers: this.headers,
            schema: this.schema,
    ...
    delete({
        ...
        const t = "DELETE",
            s = [];
        return e && s.push(`count=${e}`), this.headers.Prefer && s.unshift(this.headers.Prefer), this.headers.Prefer = s.join(","), new K({
            method: t,
            url: this.url,
            headers: this.headers,
            schema: this.schema,
...
class qe {
    constructor(e, {
        ...
        this.url = e, this.headers = Object.assign(Object.assign({}, Es), t), this.schemaName = s, this.fetch = r
    }
    from(e) {
    ...
    rpc(e, t = {}, {
        ...
        return r && (c.Prefer = `count=${r}`), new K({
            method: i,
            url: o,
            headers: c,
            schema: this.schemaName,
...
class oe {
    constructor(e, t) {
        ...
        this.channel._on(s.state, {}, r => {
            ...
            this.joinRef = this.channel._joinRef(), this.state = oe.syncState(this.state, r, i, o), this.pendingDiffs.forEach(c => {
        ...
        return this.map(i, (l, h) => {
            ...
            if (u) {
                const d = h.map(p => p.presence_ref),
                    g = u.map(p => p.presence_ref),
                    _ = h.filter(p => g.indexOf(p.presence_ref) < 0),
                    f = u.filter(p => d.indexOf(p.presence_ref) < 0);
    ...
    static syncDiff(e, t, s, r) {
        ...
        return s || (s = () => {}), r || (r = () => {}), this.map(i, (a, c) => {
            var l;
            const h = (l = e[a]) !== null && l !== void 0 ? l : [];
            if (e[a] = this.cloneDeep(c), h.length > 0) {
                const u = e[a].map(g => g.presence_ref),
                    d = h.filter(g => u.indexOf(g.presence_ref) < 0);
                e[a].unshift(...d)
            }
            s(a, h, c)
        }), this.map(o, (a, c) => {
...
const Qe = (n, e, t = {}) => {
    ...
    Rs = (n, e, t, s) => {
        const r = e.find(a => a.name === n),
            ...
            o = t[n];
        return i && !s.includes(i) ? Et(i, o) : xe(o)
    },
    Et = (n, e) => {
        if (n.charAt(0) === "_") {
    ...
    Us = (n, e) => {
        ...
        if (n[0] === "{" && s === "}") {
            ...
            return i.map(a => Et(e, a))
        }
        return n
    },
    Ds = n => typeof n == "string" ? n.replace(" ", "T") : n;
var Ye;
(function(n) {
...
class Me {
    constructor(e, t = {
        ...
        this.topic = e, this.params = t, this.socket = s, this.bindings = {}, this.state = $.closed, this.joinedOnce = !1, this.pushBuffer = [], this.subTopic = e.replace(/^realtime:/i, ""), this.params.config = Object.assign({
            broadcast: {
                ack: !1,
                self: !1
            },
        ...
        }, t.config), this.timeout = this.socket.timeout, this.joinPush = new Se(this, P.join, this.params, this.timeout), this.rejoinTimer = new Ot(() => this._rejoinUntilConnected(), this.socket.reconnectAfterMs), this.joinPush.receive("ok", () => {
            this.state = $.joined, this.rejoinTimer.reset(), this.pushBuffer.forEach(r => r.send()), this.pushBuffer = []
        }), this._onClose(() => {
            this.rejoinTimer.reset(), this.socket.log("channel", `close ${this.topic} ${this._joinRef()}`), this.state = $.closed, this.socket._remove(this)
        }), this._onError(r => {
            this._isLeaving() || this._isClosed() || (this.socket.log("channel", `error ${this.topic}`, r), this.state = $.errored, this.rejoinTimer.scheduleTimeout())
        ...
        }), this._on(P.reply, {}, (r, i) => {
            this._trigger(this._replyEventName(i), r)
        }), this.presence = new oe(this), this.broadcastEndpointURL = this._broadcastEndpointURL()
    }
                ...
                if (this.socket.accessToken && this.socket.setAuth(this.socket.accessToken), l === void 0) {
                    ...
                    for (let _ = 0; _ < d; _++) {
                        const f = u[_],
                            ...
                            m = l && l[_];
                        if (m && m.event === p && m.schema === w && m.table === k && m.filter === E) g.push(Object.assign(Object.assign({}, f), {
                            id: m.id
                        }));
                        else {
    ...
    _trigger(e, t, s) {
        ...
        ["insert", "update", "delete"].includes(o) ? (r = this.bindings.postgres_changes) === null || r === void 0 || r.filter(g => {
            var _, f, p;
            return ((_ = g.filter) === null || _ === void 0 ? void 0 : _.event) === "*" || ((p = (f = g.filter) === null || f === void 0 ? void 0 : f.event) === null || p === void 0 ? void 0 : p.toLocaleLowerCase()) === o
        }).map(g => g.callback(d, s)) : (i = this.bindings[o]) === null || i === void 0 || i.filter(g => {
            var _, f, p, w, k, E;
            if (["broadcast", "presence", "postgres_changes"].includes(o))
                if ("id" in g) {
                    const m = g.id,
                        he = (_ = g.filter) === null || _ === void 0 ? void 0 : _.event;
                    return m && ((f = t.ids) === null || f === void 0 ? void 0 : f.includes(m)) && (he === "*" || (he == null ? void 0 : he.toLocaleLowerCase()) === ((p = t.data) === null || p === void 0 ? void 0 : p.type.toLocaleLowerCase()))
                } else {
                    const m = (k = (w = g == null ? void 0 : g.filter) === null || w === void 0 ? void 0 : w.event) === null || k === void 0 ? void 0 : k.toLocaleLowerCase();
                    return m === "*" || m === ((E = t == null ? void 0 : t.event) === null || E === void 0 ? void 0 : E.toLocaleLowerCase())
                }
    ...
    _rejoin(e = this.timeout) {
        this._isLeaving() || (this.socket._leaveOpenTopic(this.topic), this.state = $.joining, this.joinPush.resend(e))
    }
    _getPayloadRecords(e) {
        ...
        return (e.type === "INSERT" || e.type === "UPDATE") && (t.new = Qe(e.columns, e.record)), (e.type === "UPDATE" || e.type === "DELETE") && (t.old = Qe(e.columns, e.old_record)), t
    }
}
const Ns = () => {},
    Fs = typeof WebSocket < "u";
class qs {
    constructor(e, t) {
        var s;
        this.accessToken = null, this.apiKey = null, this.channels = [], this.endPoint = "", this.headers = Cs, this.params = {}, this.timeout = Tt, this.heartbeatIntervalMs = 3e4, this.heartbeatTimer = void 0, this.pendingHeartbeatRef = null, this.ref = 0, this.logger = Ns, this.conn = null, this.sendBuffer = [], this.serializer = new Ps, this.stateChangeCallbacks = {
            open: [],
            close: [],
            error: [],
            message: []
            ...
            let o;
            return i ? o = i : typeof fetch > "u" ? o = (...a) => W(() => Promise.resolve().then(() => ce), void 0,
                import.meta.url).then(({
                default: c
            }) => c(...a)) : o = fetch, (...a) => o(...a)
        }, this.endPoint = `${e}/${Re.websocket}`, t != null && t.transport ? this.transport = t.transport : this.transport = null, t != null && t.params && (this.params = t.params), t != null && t.headers && (this.headers = Object.assign(Object.assign({}, this.headers), t.headers)), t != null && t.timeout && (this.timeout = t.timeout), t != null && t.logger && (this.logger = t.logger), t != null && t.heartbeatIntervalMs && (this.heartbeatIntervalMs = t.heartbeatIntervalMs);
        const r = (s = t == null ? void 0 : t.params) === null || s === void 0 ? void 0 : s.apikey;
        r && (this.accessToken = r, this.apiKey = r), this.reconnectAfterMs = t != null && t.reconnectAfterMs ? t.reconnectAfterMs : i => [1e3, 2e3, 5e3, 1e4][i - 1] || 1e4, this.encode = t != null && t.encode ? t.encode : (i, o) => o(JSON.stringify(i)), this.decode = t != null && t.decode ? t.decode : this.serializer.decode.bind(this.serializer), this.reconnectTimer = new Ot(async () => {
    ...
    connect() {
        if (!this.conn) {
            ...
            this.conn = new Ms(this._endPointURL(), void 0, {
                close: () => {
                    this.conn = null
                }
            }), W(() =>
                import ("../chunks/browser.06aa05b2.js").then(e => e.b), [],
                import.meta.url).then(({
                default: e
            }) => {
    ...
    setAuth(e) {
        this.accessToken = e, this.channels.forEach(t => {
            e && t.updateJoinPayload({
                access_token: e
            }), t.joinedOnce && t._isJoined() && t._push(P.access_token, {
                access_token: e
            })
        })
    }
    ...
    _sendHeartbeat() {
        ...
        if (this.isConnected()) {
            if (this.pendingHeartbeatRef) {
                this.pendingHeartbeatRef = null, this.log("transport", "heartbeat timeout. Attempting to re-establish connection"), (e = this.conn) === null || e === void 0 || e.close(As, "hearbeat timeout");
                return
            }
...
class Ms {
    constructor(e, t, s) {
        this.binaryType = "arraybuffer", this.onclose = () => {}, this.onerror = () => {}, this.onmessage = () => {}, this.onopen = () => {}, this.readyState = G.connecting, this.send = () => {}, this.url = null, this.url = e, this.close = s.close
    }
}
...
var Js = globalThis && globalThis.__awaiter || function(n, e, t, s) {
    function r(i) {
        return i instanceof t ? i : new t(function(o) {
            o(i)
        })
...
const $t = n => {
    ...
    zs = () => Js(void 0, void 0, void 0, function*() {
        return typeof Response > "u" ? (yield W(() => Promise.resolve().then(() => ce), void 0,
            import.meta.url)).Response : Response
    });
var re = globalThis && globalThis.__awaiter || function(n, e, t, s) {
    function r(i) {
        return i instanceof t ? i : new t(function(o) {
            o(i)
        })
...
const Te = n => n.msg || n.message || n.error_description || n.error || JSON.stringify(n),
    Ks = (n, e) => re(void 0, void 0, void 0, function*() {
        const t = yield zs();
        n instanceof t ? n.json().then(s => {
            e(new Bs(Te(s), n.status || 500))
        }).catch(s => {
            e(new tt(Te(s), s))
        }) : e(new tt(Te(n), n))
    }),
    Hs = (n, e, t, s) => {
        ...
        return n === "GET" ? r : (r.headers = Object.assign({
            "Content-Type": "application/json"
        }, e == null ? void 0 : e.headers), r.body = JSON.stringify(s), Object.assign(Object.assign({}, r), t))
    };

function we(n, e, t, s, r, i) {
    return re(this, void 0, void 0, function*() {
        return new Promise((o, a) => {
            n(t, Hs(e, s, r, i)).then(c => {
                if (!c.ok) throw c;
                return s != null && s.noResolveJson ? c : c.json()
            }).then(c => o(c)).catch(c => Ks(c, a))
        })
    })
}
...
function Ie(n, e, t, s) {
    return re(this, void 0, void 0, function*() {
        return we(n, "GET", e, t, s)
    })
}

function x(n, e, t, s, r) {
    return re(this, void 0, void 0, function*() {
        return we(n, "POST", e, s, r, t)
    })
}

function Gs(n, e, t, s, r) {
    return re(this, void 0, void 0, function*() {
        return we(n, "PUT", e, s, r, t)
    })
}

function Ct(n, e, t, s, r) {
    return re(this, void 0, void 0, function*() {
        return we(n, "DELETE", e, s, r, t)
    })
}
var j = globalThis && globalThis.__awaiter || function(n, e, t, s) {
    function r(i) {
        return i instanceof t ? i : new t(function(o) {
            o(i)
        })
...
class Ws {
    constructor(e, t = {}, s, r) {
        this.url = e, this.headers = t, this.bucketId = s, this.fetch = $t(r)
    }
    uploadOrUpdate(e, t, s, r) {
        return j(this, void 0, void 0, function*() {
            try {
                let i;
                const o = Object.assign(Object.assign({}, st), r),
    ...
    createSignedUploadUrl(e) {
        return j(this, void 0, void 0, function*() {
            try {
                ...
                const s = yield x(this.fetch, `${this.url}/object/upload/sign/${t}`, {}, {
                    headers: this.headers
                }), r = new URL(this.url + s.url), i = r.searchParams.get("token");
                if (!i) throw new Be("No token returned by API");
                return {
                    data: {
    ...
    download(e, t) {
        return j(this, void 0, void 0, function*() {
            ...
            try {
                ...
                return {
                    data: yield(yield Ie(this.fetch, `${this.url}/${r}/${a}${o}`, {
                        headers: this.headers,
                        noResolveJson: !0
                    })).blob(), error: null
                }
    ...
    remove(e) {
        return j(this, void 0, void 0, function*() {
            try {
                return {
                    data: yield Ct(this.fetch, `${this.url}/object/${this.bucketId}`, {
                        prefixes: e
                    }, {
                        headers: this.headers
                    }), error: null
    ...
    list(e, t, s) {
        return j(this, void 0, void 0, function*() {
            try {
                const r = Object.assign(Object.assign(Object.assign({}, Vs), t), {
                    prefix: e || ""
                });
                return {
...
const Xs = "2.5.5",
    Qs = {
        "X-Client-Info": `storage-js/${Xs}`
    };
var q = globalThis && globalThis.__awaiter || function(n, e, t, s) {
    function r(i) {
        return i instanceof t ? i : new t(function(o) {
            o(i)
        })
...
class Ys {
    constructor(e, t = {}, s) {
        this.url = e, this.headers = Object.assign(Object.assign({}, Qs), t), this.fetch = $t(s)
    }
    listBuckets() {
        return q(this, void 0, void 0, function*() {
            try {
                return {
                    data: yield Ie(this.fetch, `${this.url}/bucket`, {
                        headers: this.headers
                    }), error: null
                }
            } catch (e) {
    ...
    getBucket(e) {
        return q(this, void 0, void 0, function*() {
            try {
                return {
                    data: yield Ie(this.fetch, `${this.url}/bucket/${e}`, {
                        headers: this.headers
                    }), error: null
                }
            } catch (t) {
    ...
    updateBucket(e, t) {
        return q(this, void 0, void 0, function*() {
            try {
                return {
                    data: yield Gs(this.fetch, `${this.url}/bucket/${e}`, {
                        id: e,
                        name: e,
                        public: t.public,
                        file_size_limit: t.fileSizeLimit,
...
class Zs extends Ys {
    ...
    from(e) {
        return new Ws(this.url, this.headers, e, this.fetch)
    }
}
const er = "2.39.3";
let ne = "";
...
const tr = {
    "X-Client-Info": `supabase-js-${ne}/${er}`
};
var sr = globalThis && globalThis.__awaiter || function(n, e, t, s) {
    function r(i) {
        return i instanceof t ? i : new t(function(o) {
            o(i)
        })
...
const rr = n => {
        let e;
        return n ? e = n : typeof fetch > "u" ? e = Fe : e = fetch, (...t) => e(...t)
    },
    ir = () => typeof Headers > "u" ? St : Headers,
    nr = (n, e, t) => {
        const s = rr(t),
            r = ir();
        return (i, o) => sr(void 0, void 0, void 0, function*() {
            var a;
            const c = (a = yield e()) !== null && a !== void 0 ? a : n;
            let l = new r(o == null ? void 0 : o.headers);
            return l.has("apikey") || l.set("apikey", n), l.has("Authorization") || l.set("Authorization", `Bearer ${c}`), s(i, Object.assign(Object.assign({}, o), {
                headers: l
            }))
        })
    };
...
const A = () => typeof document < "u",
    ...
    ae = () => {
        ...
        try {
            globalThis.localStorage.setItem(n, n), globalThis.localStorage.removeItem(n), L.tested = !0, L.writable = !0
        } catch {
...
const jt = n => {
    ...
    hr = n => typeof n == "object" && n !== null && "status" in n && "ok" in n && "json" in n && typeof n.json == "function",
    U = async (n, e, t) => {
...
function ur(n) {
    ...
    let t = "",
        s, r, i, o, a, c, l, h = 0;
    for (n = n.replace("-", "+").replace("_", "/"); h < n.length;) o = e.indexOf(n.charAt(h++)), a = e.indexOf(n.charAt(h++)), c = e.indexOf(n.charAt(h++)), l = e.indexOf(n.charAt(h++)), s = o << 2 | a >> 4, r = (a & 15) << 4 | c >> 2, i = (c & 3) << 6 | l, t = t + String.fromCharCode(s), c != 64 && r != 0 && (t = t + String.fromCharCode(r)), l != 64 && i != 0 && (t = t + String.fromCharCode(i));
    return t
}
class ke {
    constructor() {
...
var br = globalThis && globalThis.__rest || function(n, e) {
    var t = {};
...
const H = n => n.msg || n.message || n.error_description || n.error || JSON.stringify(n),
    wr = [502, 503, 504];
async function nt(n) {
    if (!hr(n)) throw new Le(H(n), 0);
    if (wr.includes(n.status)) throw new Le(H(n), n.status);
    let e;
    try {
        e = await n.json()
    } catch (t) {
    ...
    throw typeof e == "object" && e && typeof e.weak_password == "object" && e.weak_password && Array.isArray(e.weak_password.reasons) && e.weak_password.reasons.length && e.weak_password.reasons.reduce((t, s) => t && typeof s == "string", !0) ? new yr(H(e), n.status, e.weak_password.reasons) : new mr(H(e), n.status || 500)
}
const kr = (n, e, t, s) => {
    const r = {
        method: n,
...
async function y(n, e, t, s) {
    ...
    return s != null && s.xform ? s == null ? void 0 : s.xform(c) : {
        data: Object.assign({}, c),
        error: null
    }
}
async function Sr(n, e, t, s, r, i) {
    const o = kr(e, s, r, i);
    let a;
    try {
        a = await n(t, o)
    } catch (c) {
        throw console.error(c), new Le(H(c), 0)
    }
...
function D(n) {
    var e;
    let t = null;
    $r(n) && (t = Object.assign({}, n), n.expires_at || (t.expires_at = lr(n.expires_in)));
...
var Cr = globalThis && globalThis.__rest || function(n, e) {
    var t = {};
    for (var s in n) Object.prototype.hasOwnProperty.call(n, s) && e.indexOf(s) < 0 && (t[s] = n[s]);
    if (n != null && typeof Object.getOwnPropertySymbols == "function")
        for (var r = 0, s = Object.getOwnPropertySymbols(n); r < s.length; r++) e.indexOf(s[r]) < 0 && Object.prototype.propertyIsEnumerable.call(n, s[r]) && (t[s[r]] = n[s[r]]);
...
class jr {
    ...
    async generateLink(e) {
        try {
            const {
                options: t
            } = e, s = Cr(e, ["options"]), r = Object.assign(Object.assign({}, s), t);
    ...
    async listUsers(e) {
        ...
        try {
            const l = {
                ...
                h = await y(this.fetch, "GET", `${this.url}/admin/users`, {
                    headers: this.headers,
                    noResolveJson: !0,
                    query: {
            ...
            const u = await h.json(),
                ...
                g = (c = (a = h.headers.get("link")) === null || a === void 0 ? void 0 : a.split(",")) !== null && c !== void 0 ? c : [];
            return g.length > 0 && (g.forEach(_ => {
...
const Pt = "2.62.0",
    Ar = "http://localhost:9999",
    Pr = "supabase.auth.token",
    Rr = {
        "X-Client-Info": `gotrue-js/${Pt}`
    },
    at = 10,
    xr = {
        getItem: n => ae() ? globalThis.localStorage.getItem(n) : null,
        setItem: (n, e) => {
            ae() && globalThis.localStorage.setItem(n, e)
        },
        removeItem: n => {
            ae() && globalThis.localStorage.removeItem(n)
        }
    };
...
const z = {
    debug: !!(globalThis && ae() && globalThis.localStorage && globalThis.localStorage.getItem("supabase.gotrue-js.locks.debug") === "true")
};
...
async function Ur(n, e, t) {
    z.debug && console.log("@supabase/gotrue-js: navigatorLock: acquire lock", n, e);
    const s = new globalThis.AbortController;
    return e > 0 && setTimeout(() => {
        s.abort(), z.debug && console.log("@supabase/gotrue-js: navigatorLock acquire timed out", n)
        ...
        if (r) {
            z.debug && console.log("@supabase/gotrue-js: navigatorLock: acquired", n, r.name);
            try {
                return await t()
            } finally {
                z.debug && console.log("@supabase/gotrue-js: navigatorLock: released", n, r.name)
            }
        } else {
            if (e === 0) throw z.debug && console.log("@supabase/gotrue-js: navigatorLock: not immediately available", n), new Lr(`Acquiring an exclusive Navigator LockManager lock "${n}" immediately failed`);
            if (z.debug) try {
...
class le {
    constructor(e) {
        ...
        if (this.logDebugMessages = !!r.debug, typeof r.debug == "function" && (this.logger = r.debug), this.persistSession = r.persistSession, this.storageKey = r.storageKey, this.autoRefreshToken = r.autoRefreshToken, this.admin = new jr({
                url: r.url,
                headers: r.headers,
                fetch: r.fetch
            }), this.url = r.url, this.headers = r.headers, this.fetch = jt(r.fetch), this.lock = r.lock || ht, this.detectSessionInUrl = r.detectSessionInUrl, this.flowType = r.flowType, r.lock ? this.lock = r.lock : A() && (!((t = globalThis == null ? void 0 : globalThis.navigator) === null || t === void 0) && t.locks) ? this.lock = Ur : this.lock = ht, this.mfa = {
            ...
            }, this.persistSession ? r.storage ? this.storage = r.storage : ae() ? this.storage = xr : (this.memoryStorage = {}, this.storage = lt(this.memoryStorage)) : (this.memoryStorage = {}, this.storage = lt(this.memoryStorage)), A() && globalThis.BroadcastChannel && this.persistSession && this.storageKey) {
            try {
    ...
    _debug(...e) {
        return this.logDebugMessages && this.logger(`GoTrueClient@${this.instanceID} (${Pt}) ${new Date().toISOString()}`, ...e), this
    }
    async initialize() {
    ...
    async _initialize() {
        try {
            const e = A() ? await this._isPKCEFlow() : !1;
            if (this._debug("#_initialize()", "begin", "is PKCE flow", e), e || this.detectSessionInUrl && this._isImplicitGrantFlow()) {
                ...
                if (s) return this._debug("#_initialize()", "error detecting session from URL", s), (s == null ? void 0 : s.message) === "Identity is already linked" || (s == null ? void 0 : s.message) === "Identity is already linked to another user" ? {
                    error: s
            ...
            return v(e) ? {
                ...
                error: new At("Unexpected error during initialization", e)
            }
        } finally {
        ...
        try {
            ...
            if ("email" in e) {
                ...
                if (this.flowType === "pkce") {
                    const f = M();
                    await U(this.storage, `${this.storageKey}-code-verifier`, f), g = await B(f), _ = f === g ? "plain" : "s256"
                }
            ...
            } else throw new de("You must provide either an email or phone number and a password");
            const {
                data: o,
                error: a
            } = i;
            ...
            const c = o.session,
                l = o.user;
            return o.session && (await this._saveSession(o.session), await this._notifyAllSubscribers("SIGNED_IN", c)), {
                data: {
                    user: l,
                    session: c
                },
    ...
    async _exchangeCodeForSession(e) {
        ...
        return await Ee(this.storage, `${this.storageKey}-code-verifier`), o ? {
            data: {
                user: null,
                session: null,
                redirectType: null
    ...
    async signInWithIdToken(e) {
        ...
        try {
            const {
                ...
                access_token: i,
                nonce: o
            } = e, a = await y(this.fetch, "POST", `${this.url}/token?grant_type=id_token`, {
                headers: this.headers,
                body: {
                    provider: s,
                    id_token: r,
    ...
    async signInWithOtp(e) {
        ...
        try {
            if (await this._removeSession(), "email" in e) {
                ...
                if (this.flowType === "pkce") {
                    const d = M();
                    await U(this.storage, `${this.storageKey}-code-verifier`, d), l = await B(d), h = d === l ? "plain" : "s256"
                }
                const {
                    error: u
    ...
    async signInWithSSO(e) {
        ...
        try {
            ...
            if (this.flowType === "pkce") {
                const a = M();
                await U(this.storage, `${this.storageKey}-code-verifier`, a), i = await B(a), o = a === i ? "plain" : "s256"
            }
            return await y(this.fetch, "POST", `${this.url}/sso`, {
    ...
    async __loadSession() {
        ...
        try {
            ...
            if (this._debug("#__loadSession()", `session has${s?"":" not"} expired`, "expires_at", e.expires_at), !s) return {
                data: {
                    session: e
                },
                error: null
    ...
    async _getUser(e) {
        try {
            return e ? await y(this.fetch, "GET", `${this.url}/user`, {
                ...
                if (o) throw o;
                return await y(this.fetch, "GET", `${this.url}/user`, {
                    headers: this.headers,
        ...
        try {
            return await this._useSession(async s => {
                ...
                if (this.flowType === "pkce" && e.email != null) {
                    const u = M();
                    await U(this.storage, `${this.storageKey}-code-verifier`, u), a = await B(u), c = u === a ? "plain" : "s256"
                }
                const {
                    data: l,
                    error: h
                ...
                if (h) throw h;
                return o.user = l.user, await this._saveSession(o), await this._notifyAllSubscribers("USER_UPDATED", o), {
                    data: {
                        user: o.user
                    },
                    error: null
    ...
    async _getSessionFromURL(e) {
        try {
            if (!A()) throw new fe("No browser detected.");
            if (this.flowType === "implicit" && !this._isImplicitGrantFlow()) throw new fe("Not a valid implicit grant flow url.");
            if (this.flowType == "pkce" && !e) throw new it("Not a valid PKCE flow url.");
            const t = Oe(window.location.href);
            if (e) {
                if (!t.code) throw new it("No code detected.");
                const {
                    data: k,
                    error: E
                ...
                return m.searchParams.delete("code"), window.history.replaceState(window.history.state, "", m.toString()), {
                    data: {
                        session: k.session,
                        redirectType: null
                    },
            ...
            if (t.error || t.error_description || t.error_code) throw new fe(t.error_description || "Error in URL with unspecified error_description", {
            ...
            if (!i || !a || !o || !l) throw new fe("No session defined in URL");
            const h = Math.round(Date.now() / 1e3),
                u = parseInt(a);
            let d = h + u;
            c && (d = parseInt(c));
            const g = d - h;
            g * 1e3 <= ie && console.warn(`@supabase/gotrue-js: Session as retrieved from URL expires in ${g}s, should have been closer to ${u}s`);
            const _ = d - u;
            h - _ >= 120 ? console.warn("@supabase/gotrue-js: Session as retrieved from URL was issued over 120s ago, URL could be stale", _, d, h) : h - _ < 0 && console.warn("@supabase/gotrue-js: Session as retrieved from URL was issued in the future? Check the device clok for skew", _, d, h);
            const {
                data: f,
                error: p
    ...
    async _isPKCEFlow() {
        const e = Oe(window.location.href),
            t = await ue(this.storage, `${this.storageKey}-code-verifier`);
        return !!(e.code && t)
    }
    async signOut(e = {
        scope: "global"
    ...
    async _signOut({
        ...
        return await this._useSession(async t => {
            ...
            if (o) {
                ...
                if (a && !(vr(a) && (a.status === 404 || a.status === 401))) return {
                    error: a
                }
            }
            return e !== "others" && (await this._removeSession(), await Ee(this.storage, `${this.storageKey}-code-verifier`), await this._notifyAllSubscribers("SIGNED_OUT", null)), {
                error: null
            }
        })
    }
    ...
    async resetPasswordForEmail(e, t = {}) {
        ...
        if (this.flowType === "pkce") {
            const i = M();
            await U(this.storage, `${this.storageKey}-code-verifier`, `${i}/PASSWORD_RECOVERY`), s = await B(i), r = i === s ? "plain" : "s256"
        }
        try {
    ...
    async linkIdentity(e) {
        ...
        try {
            const {
                ...
                return await y(this.fetch, "GET", g, {
                    headers: this.headers,
                    jwt: (h = (l = u.session) === null || l === void 0 ? void 0 : l.access_token) !== null && h !== void 0 ? h : void 0
                })
            });
            if (r) throw r;
            return A() && !(!((t = e.options) === null || t === void 0) && t.skipBrowserRedirect) && window.location.assign(s == null ? void 0 : s.url), {
                data: {
                    provider: e.provider,
    ...
    async _refreshAccessToken(e) {
        ...
        try {
            const s = Date.now();
            return await fr(async r => (await dr(r * 200), this._debug(t, "refreshing attempt", r), await y(this.fetch, "POST", `${this.url}/token?grant_type=refresh_token`, {
                body: {
                    refresh_token: e
                },
                headers: this.headers,
                xform: D
            })), (r, i, o) => o && o.error && Ce(o.error) && Date.now() + (r + 1) * 200 - s < ie)
        } catch (s) {
            if (this._debug(t, "error", s), v(s)) return {
                data: {
                    session: null,
                    user: null
                },
    ...
    async _handleProviderSignIn(e, t) {
        ...
        return this._debug("#_handleProviderSignIn()", "provider", e, "options", t, "url", s), A() && !t.skipBrowserRedirect && window.location.assign(s), {
            data: {
                provider: e,
                url: s
            },
    ...
    async _recoverAndRefresh() {
        ...
        try {
            ...
            const r = Math.round(Date.now() / 1e3),
                i = ((e = s.expires_at) !== null && e !== void 0 ? e : 1 / 0) < r + at;
            if (this._debug(t, `session has${i?"":" not"} expired with margin of ${at}s`), i) {
                if (this.autoRefreshToken && s.refresh_token) {
                    const {
                        error: o
                    } = await this._callRefreshToken(s.refresh_token);
                    o && (console.error(o), Ce(o) || (this._debug(t, "refresh failed with a non-retryable error, removing the session", o), await this._removeSession()))
                }
    ...
    async _callRefreshToken(e) {
        ...
        try {
            ...
            if (this._debug(r, "error", i), v(i)) {
                ...
                return Ce(i) || (await this._removeSession(), await this._notifyAllSubscribers("SIGNED_OUT", null)), (t = this.refreshingDeferred) === null || t === void 0 || t.resolve(o), o
            }
    ...
    async _saveSession(e) {
        this._debug("#_saveSession()", e), await U(this.storage, this.storageKey, e)
    }
    async _removeSession() {
        this._debug("#_removeSession()"), await Ee(this.storage, this.storageKey)
    }
                ...
                try {
                    ...
                    try {
                        return await this._useSession(async t => {
                            ...
                            this._debug("#_autoRefreshTokenTick()", `access token expires in ${r} ticks, a tick lasts ${ie}ms, refresh threshold is ${ct} ticks`), r <= ct && await this._callRefreshToken(s.refresh_token)
                        })
                    } catch (t) {
    ...
    async _getUrlForProvider(e, t, s) {
        ...
        if (s != null && s.redirectTo && r.push(`redirect_to=${encodeURIComponent(s.redirectTo)}`), s != null && s.scopes && r.push(`scopes=${encodeURIComponent(s.scopes)}`), this.flowType === "pkce") {
            const i = M();
            await U(this.storage, `${this.storageKey}-code-verifier`, i);
            const o = await B(i),
                a = i === o ? "plain" : "s256";
        ...
        try {
            return await this._useSession(async t => {
                ...
                return c ? {
                    data: null,
                    error: c
                } : (!((r = a == null ? void 0 : a.totp) === null || r === void 0) && r.qr_code && (a.totp.qr_code = `data:image/svg+xml;utf-8,${a.totp.qr_code}`), {
                    data: a,
                    error: null
                })
            })
...
var Fr = globalThis && globalThis.__awaiter || function(n, e, t, s) {
    function r(i) {
        return i instanceof t ? i : new t(function(o) {
            o(i)
        })
...
class zr {
    constructor(e, t, s) {
        var r, i, o, a, c, l, h, u;
        if (this.supabaseUrl = e, this.supabaseKey = t, this.from = p => this.rest.from(p), this.schema = p => this.rest.schema(p), this.rpc = (p, w = {}, k) => this.rest.rpc(p, w, k), !e) throw new Error("supabaseUrl is required.");
        ...
        const g = `sb-${new URL(this.authUrl).hostname.split(".")[0]}-auth-token`,
            _ = {
                db: Mr,
                realtime: Jr,
                auth: Object.assign(Object.assign({}, Br), {
                    storageKey: g
                }),
                global: qr
            },
            f = ar(s ? ? {}, _);
        this.storageKey = (i = (r = f.auth) === null || r === void 0 ? void 0 : r.storageKey) !== null && i !== void 0 ? i : "", this.headers = (a = (o = f.global) === null || o === void 0 ? void 0 : o.headers) !== null && a !== void 0 ? a : {}, this.auth = this._initSupabaseAuthClient((c = f.auth) !== null && c !== void 0 ? c : {}, this.headers, (l = f.global) === null || l === void 0 ? void 0 : l.fetch), this.fetch = nr(t, this._getAccessToken.bind(this), (h = f.global) === null || h === void 0 ? void 0 : h.fetch), this.realtime = this._initRealtimeClient(Object.assign({
            headers: this.headers
        }, f.realtime)), this.rest = new qe(`${d}/rest/v1`, {
            headers: this.headers,
    ...
    get functions() {
        return new ms(this.functionsUrl, {
            headers: this.headers,
            customFetch: this.fetch
        })
    }
    get storage() {
        return new Zs(this.storageUrl, this.headers, this.fetch)
    }
    channel(e, t = {
        config: {}
    }) {
    ...
    _initRealtimeClient(e) {
        return new qs(this.realtimeUrl, Object.assign(Object.assign({}, e), {
...
var Hr = Object.create,
    ...
    Xr = (n, e) => function() {
        return e || (0, n[It(n)[0]])((e = {
            exports: {}
        }).exports, e), e.exports
    },
    Qr = (n, e, t, s) => {
        if (e && typeof e == "object" || typeof e == "function")
            for (let r of It(e)) !Wr.call(n, r) && r !== t && xt(n, r, {
                get: () => e[r],
                enumerable: !(s = Gr(e, r)) || s.enumerable
            });
        return n
    },
    Lt = (n, e, t) => (t = n != null ? Hr(Vr(n)) : {}, Qr(e || !n || !n.__esModule ? xt(t, "default", {
        value: n,
        enumerable: !0
    }) : t, n)),
    Ut = Xr({
        "../../node_modules/.pnpm/cookie@0.5.0/node_modules/cookie/index.js" (n) {
            n.parse = s, n.serialize = r;
            var e = Object.prototype.toString,
                t = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/;

            function s(l, h) {
                if (typeof l != "string") throw new TypeError("argument str must be a string");
                for (var u = {}, d = h || {}, g = d.decode || i, _ = 0; _ < l.length;) {
                    var f = l.indexOf("=", _);
                    if (f === -1) break;
                    var p = l.indexOf(";", _);
                    if (p === -1) p = l.length;
                    ...
                    if (u[w] === void 0) {
                        var k = l.slice(f + 1, p).trim();
                        k.charCodeAt(0) === 34 && (k = k.slice(1, -1)), u[w] = c(k, g)
                    }
                    _ = p + 1
                }
                return u
            ...
            function r(l, h, u) {
                var d = u || {},
                    g = d.encode || o;
                if (typeof g != "function") throw new TypeError("option encode is invalid");
                ...
                if (d.domain) {
                    if (!t.test(d.domain)) throw new TypeError("option domain is invalid");
                    f += "; Domain=" + d.domain
                }
                if (d.path) {
                ...
                if (d.httpOnly && (f += "; HttpOnly"), d.secure && (f += "; Secure"), d.priority) {
...
function ut(n) {
    ...
    try {
        ...
        const [t, s, r] = e[0].split("."), i = us(s), o = new TextDecoder, {
            exp: a,
            sub: c,
            ...l
        } = JSON.parse(o.decode(i));
        return {
            expires_at: a,
...
function Yr(n) {
    var e;
    return JSON.stringify([n.access_token, n.refresh_token, n.provider_token, n.provider_refresh_token, ((e = n.user) == null ? void 0 : e.factors) ? ? null])
}
...
function Nt(n) {
    return new RegExp(".{1," + n + "}", "g")
}
var Ft = 3180,
    Zr = Nt(Ft);

function ei(n, e, t) {
    const s = t !== void 0 ? Nt(t) : Zr;
    if (Math.ceil(e.length / (t ? ? Ft)) === 1) return [{
        name: n,
        value: e
    }];
    const i = [],
        o = e.match(s);
    return o == null || o.forEach((a, c) => {
        const l = `${n}.${c}`;
        i.push({
            name: l,
            value: a
...
var si = class {
        constructor(n) {
            this.cookieOptions = { ...dt,
                ...n,
                maxAge: dt.maxAge
            }
        }
        getItem(n) {
            const e = this.getCookie(n);
            if (n.endsWith("-code-verifier") && e) return e;
            if (e) return JSON.stringify(ut(e));
            const t = ti(n, s => this.getCookie(s));
            return t !== null ? JSON.stringify(ut(t)) : null
        }
        setItem(n, e) {
            if (n.endsWith("-code-verifier")) {
                this.setCookie(n, e);
                return
            }
            let t = JSON.parse(e);
            const s = Yr(t);
            ei(n, s).forEach(i => {
                this.setCookie(i.name, i.value)
            })
        }
        removeItem(n) {
            this._deleteSingleCookie(n), this._deleteChunkedCookies(n)
        }
        _deleteSingleCookie(n) {
            this.getCookie(n) && this.deleteCookie(n)
        }
        _deleteChunkedCookies(n, e = 0) {
            for (let t = e;; t++) {
                const s = `${n}.${t}`;
                if (this.getCookie(s) === void 0) break;
                this.deleteCookie(s)
            }
        }
    },
    ri = class extends si {
        ...
        getCookie(n) {
            return V() ? (0, je.parse)(document.cookie)[n] : null
        }
        setCookie(n, e) {
            if (!V()) return null;
            document.cookie = (0, je.serialize)(n, e, { ...this.cookieOptions,
                httpOnly: !1
            })
        }
        deleteCookie(n) {
            if (!V()) return null;
            document.cookie = (0, je.serialize)(n, "", { ...this.cookieOptions,
                maxAge: 0,
                httpOnly: !1
            })
        }
...
var ni = class extends ri {
        constructor(n = null, e) {
            super(e), this.serverSession = n
        }
        getItem(n) {
            return V() ? super.getItem(n) : JSON.stringify(this.serverSession)
        }
    },
    Ae;
...
function oi({
    ...
    const c = ii(n, e, { ...r,
        global: {
            ...
            headers: { ...(o = r == null ? void 0 : r.global) == null ? void 0 : o.headers,
...
async function ai(n) {
    ...
    if (s) {
        const {
            data: r
        } = await t.from("users").select().filter("id", "eq", s == null ? void 0 : s.user.id).single();
        e = r
    }
    return {
        supabase: t,
...
function pt(n) {
    ...
    return e = new ss({
        ...
        p(s, r) {
            const i = {};
            r & 8 && (i.class = s[3]), r & 8192 && (i.$$scope = {
                dirty: r,
                ctx: s
            }), e.$set(i)
        },
...
function hi(n) {
    ...
    return {
        ...
        p(r, i) {
            s && s.p && (!e || i & 8192) && ve(s, t, r, r[13], e ? be(t, r[13], i, ci) : ye(r[13]), gt)
        },
        i(r) {
            e || (S(s, r), e = !0)
        },
...
function _t(n) {
    ...
    return {
        ...
        p(i, o) {
            s ? s.p && (!e || o & 139264) && ve(s, t, i, i[13], e ? be(t, i[13], o, li) : ye(i[13]), ft) : r && r.p && (!e || o & 131072) && r.p(i, e ? o : -1)
        },
        i(i) {
            e || (S(r, i), e = !0)
        },
...
function ui(n) {
    ...
    return e = new ts({
        ...
        zt(n[17]) && n[17].apply(this, arguments)
    }), {
        c() {
            Z(e.$$.fragment)
        },
...
function di(n) {
    let e, t, s, r, i, o = n[5].icon && pt(n);
    const a = n[11].default,
        c = me(a, n, n[13], null);
    let l = n[0] && _t(n);
    return {
        c() {
            o && o.c(), e = X(), t = Ue("div"), c && c.c(), s = X(), l && l.c(), r = He(), this.h()
        },
        l(h) {
            o && o.l(h), e = Q(h), t = De(h, "DIV", {
                class: !0
            });
            var u = bt(t);
            c && c.l(u), u.forEach(C), s = Q(h), l && l.l(h), r = He(), this.h()
        },
        h() {
            ge(t, "class", n[1])
        },
        m(h, u) {
            o && o.m(h, u), R(h, e, u), R(h, t, u), c && c.m(t, null), R(h, s, u), l && l.m(h, u), R(h, r, u), i = !0
        },
        p(h, u) {
            h[5].icon ? o ? (o.p(h, u), u & 32 && S(o, 1)) : (o = pt(h), o.c(), S(o, 1), o.m(e.parentNode, e)) : o && (pe(), T(o, 1, 1, () => {
                o = null
            }), _e()), c && c.p && (!i || u & 8192) && ve(c, a, h, h[13], i ? be(a, h[13], u, null) : ye(h[13]), null), (!i || u & 2) && ge(t, "class", h[1]), h[0] ? l ? (l.p(h, u), u & 1 && S(l, 1)) : (l = _t(h), l.c(), S(l, 1), l.m(r.parentNode, r)) : l && (pe(), T(l, 1, 1, () => {
                l = null
            }), _e())
        },
        i(h) {
        ...
        d(h) {
            h && (C(e), C(t), C(s), C(r)), o && o.d(h), c && c.d(h), l && l.d(h)
        }
    }
}
...
function fi(n) {
    ...
    for (let i = 0; i < s.length; i += 1) r = Pe(r, s[i]);
    return e = new es({
        props: r
    }), e.$on("close", n[12]), {
        c() {
        ...
        p(i, [o]) {
            const a = o & 21 ? Yt(s, [s[0], o & 1 && {
                dismissable: i[0]
            }, s[2], s[3], o & 16 && Zt(i[4]), o & 4 && {
                class: i[2]
            }]) : {};
            o & 139307 && (a.$$scope = {
                dirty: o,
...
const gi = "-mx-1.5 -my-1.5 text-gray-400 hover:text-gray-900 focus:!ring-gray-300 hover:bg-gray-100 dark:text-gray-500 dark:hover:text-white dark:hover:bg-gray-700";

function pi(n, e, t) {
    const s = ["dismissable", "color", "position", "divClass", "defaultIconClass", "contentClass", "align"];
    let r = ze(e, s),
        {
            $$slots: i = {},
            $$scope: o
    ...
    let {
        ...
        divClass: u = "w-full max-w-xs p-4 text-gray-500 bg-white shadow dark:text-gray-400 dark:bg-gray-800 gap-3"
    } = e, {
        defaultIconClass: d = "w-8 h-8"
    } = e, {
        contentClass: g = "w-full text-sm font-normal"
    } = e, {
        align: _ = !0
    } = e;
    const f = {
    ...
    return n.$$set = m => {
        t(16, e = Pe(Pe({}, e), Ke(m))), t(4, r = ze(e, s)), "dismissable" in m && t(0, c = m.dismissable), "color" in m && t(6, l = m.color), "position" in m && t(7, h = m.position), "divClass" in m && t(8, u = m.divClass), "defaultIconClass" in m && t(9, d = m.defaultIconClass), "contentClass" in m && t(1, g = m.contentClass), "align" in m && t(10, _ = m.align), "$$scope" in m && t(13, o = m.$$scope)
    }, n.$$.update = () => {
        t(2, p = We("flex", _ ? "items-center" : "items-start", u, f[h], e.class)), n.$$.dirty & 576 && t(3, k = We("inline-flex items-center justify-center shrink-0", w[l], d))
    }, e = Ke(e), [c, g, p, k, r, a, l, h, u, d, _, i, E, o]
}
class _i extends wt {
    constructor(e) {
        super(), kt(this, e, pi, fi, yt, {
            dismissable: 0,
            color: 6,
            position: 7,
            divClass: 8,
...
function vi(n) {
    ...
    return e = new os({
        props: {
            class: "bg-red-400 text-red-900 rounded-md p-0.5"
        }
    }), {
        c() {
            Z(e.$$.fragment)
...
function yi(n) {
    ...
    return e = new as({
        props: {
            class: "bg-teal-200 text-teal-700 rounded-md p-0.5"
        }
    }), {
        c() {
            Z(e.$$.fragment)
...
function bi(n) {
    let e, t, s, r, i = "Check icon",
        o, a;
    const c = [yi, vi],
        l = [];

    function h(u, d) {
        return u[7].type === "success" ? 0 : u[7].type === "danger" ? 1 : -1
    }
    return ~(e = h(n)) && (t = l[e] = c[e](n)), {
        c() {
            t && t.c(), s = X(), r = Ue("span"), r.textContent = i, o = X(), this.h()
        },
        l(u) {
            t && t.l(u), s = Q(u), r = De(u, "SPAN", {
                class: !0,
                "data-svelte-h": !0
            }), Qt(r) !== "svelte-6sglra" && (r.textContent = i), o = Q(u), this.h()
        },
        h() {
            ge(r, "class", "sr-only")
        },
        m(u, d) {
            ~e && l[e].m(u, d), R(u, s, d), R(u, r, d), R(u, o, d), a = !0
        },
        p(u, d) {
            let g = e;
            e = h(u), e !== g && (t && (pe(), T(l[g], 1, 1, () => {
                l[g] = null
            }), _e()), ~e ? (t = l[e], t || (t = l[e] = c[e](u), t.c()), S(t, 1), t.m(s.parentNode, s)) : t = null)
        },
        i(u) {
            a || (S(t), a = !0)
        },
...
function vt(n) {
    ...
    return e = new _i({
        props: {
            class: "bg-zinc-800 border border-zinc-700 shadow-lg max-w-md",
            $$slots: {
                icon: [bi],
                default: [mi]
            },
...
function wi(n) {
    ...
    let o = Ge(n[0]),
        a = [];
    for (let l = 0; l < o.length; l += 1) a[l] = vt(mt(n, o, l));
    const c = l => T(a[l], 1, 1, () => {
        a[l] = null
    });
    return {
        ...
        l(l) {
            i && i.l(l), e = Q(l), t = De(l, "DIV", {
                class: !0
            });
            var h = bt(t);
            for (let u = 0; u < a.length; u += 1) a[u].l(h);
            h.forEach(C), this.h()
        },
        h() {
            ge(t, "class", "fixed top-8 right-8 flex flex-col gap-3 z-50")
        },
        m(l, h) {
            i && i.m(l, h), R(l, e, h), R(l, t, h);
            for (let u = 0; u < a.length; u += 1) a[u] && a[u].m(t, null);
            s = !0
        },
        p(l, [h]) {
            if (i && i.p && (!s || h & 8) && ve(i, r, l, l[3], s ? be(r, l[3], h, null) : ye(l[3]), null), h & 1) {
                o = Ge(l[0]);
                let u;
                for (u = 0; u < o.length; u += 1) {
                    const d = mt(l, o, u);
                    a[u] ? (a[u].p(d, h), S(a[u], 1)) : (a[u] = vt(d), a[u].c(), S(a[u], 1), a[u].m(t, null))
                }
                for (pe(), u = o.length; u < a.length; u += 1) c(u);
                _e()
            }
        },
        i(l) {
            if (!s) {
                S(i, l);
                for (let h = 0; h < o.length; h += 1) S(a[h]);
                s = !0
            }
        },
        o(l) {
            T(i, l), a = a.filter(Boolean);
            for (let h = 0; h < a.length; h += 1) T(a[h]);
            s = !1
        },
        d(l) {
            l && (C(e), C(t)), i && i.d(l), Kt(a, l)
        }
    }
}
...
function ki(n, e, t) {
    ...
    Gt(() => {
        ...
        const {
            data: h
        } = a.auth.onAuthStateChange(async (u, d) => {
            (d == null ? void 0 : d.expires_at) !== (c == null ? void 0 : c.expires_at) && rs("supabase:auth")
        });
        return () => h.subscription.unsubscribe()
    }), is.register(...ns);
    const l = () => {
        const h = document.querySelector("meta[name=viewport]");
        if (h !== null) {
            let u = h.getAttribute("content") ? ? "",
                d = /maximum\-scale=[0-9\.]+/g;
            d.test(u) ? u = u.replace(d, "maximum-scale=1.0") : u = [u, "maximum-scale=1.0"].join(", "), h.setAttribute("content", u)
        }
    };
    return /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream && l(), n.$$set = h => {
        "data" in h && t(1, o = h.data), "$$scope" in h && t(3, i = h.$$scope)
    }, n.$$.update = () => {
        n.$$.dirty & 2 && ({
            supabase: a,
            session: c
...
class Fi extends wt {
    constructor(e) {
        super(), kt(this, e, ki, wi, yt, {
            data: 1
        })
    }
}
export {
    Fi as component, Ni as universal
};